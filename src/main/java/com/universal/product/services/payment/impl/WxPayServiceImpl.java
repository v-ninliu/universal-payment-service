...
import com.universal.product.constants.payment.WxPayConstants;
...
import com.universal.product.models.payment.wxpay.WxPayApi;
import com.universal.product.models.payment.wxpay.request.WxPayRefundRequest;
import com.universal.product.models.payment.wxpay.request.WxPayUnifiedorderRequest;
...
//        log.info("【微信退款】发起退款, response={}", JsonUtil.toJson(retrofitResponse.body()));
     ...
     * H5支付交易类型选择
     */
    public String switchH5TradeType(UniversalPayTypeEnum payTypeEnum){
